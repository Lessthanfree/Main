...
public class AddressBookParserTest {
    ...
    public void parseCommand_add() throws Exception {
        Person person = new AddressbookPersonBuilder().build();
        AddCommand command = (AddCommand) parser.parseCommand(AddressbookPersonUtil.getAddCommand(person));
    ...
    public void parseCommand_edit() throws Exception {
        Person person = new AddressbookPersonBuilder().build();
        EditPersonDescriptor descriptor = new AddressbookEditPersonDescriptorBuilder(person).build();
        EditCommand command = (EditCommand) parser.parseCommand(EditCommand.COMMAND_WORD + " "
                + INDEX_FIRST_PERSON.getOneBased() + " " + AddressbookPersonUtil.getEditPersonDescriptorDetails(descriptor));
