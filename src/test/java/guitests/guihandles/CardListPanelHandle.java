...
public class CardListPanelHandle extends NodeHandle<ListView<Card>> {
    ...
    /**
     * Selects the {@code CardCard} at {@code index} in the list.
     */
    ...
    /**
     * Returns true if the selected {@code CardCard} is different from the value remembered by the most recent
